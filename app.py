...
# import pytesseract
ocr = PaddleOCR(text_recognition_model_dir='./paddleppocr/best_model_50k/paddlev3_50k/inference',
                text_detection_model_dir='./paddleppocr/en_PP-OCRv3_det_infer/inference',
